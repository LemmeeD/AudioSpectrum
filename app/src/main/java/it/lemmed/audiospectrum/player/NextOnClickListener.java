...
public class NextOnClickListener implements View.OnClickListener {
    ...
    //CONSTRUCTORS
    public NextOnClickListener(PlayerActivity activity, MediaPlayer player, TextView textFilename, int currentPosition, int idPlayIcon) {
    ...
    public void onClick(View v) {
        ...
        try {
            ...
            LogDebug.log("class NextOnClickListener: onClick --> "+e.getMessage());
        }
