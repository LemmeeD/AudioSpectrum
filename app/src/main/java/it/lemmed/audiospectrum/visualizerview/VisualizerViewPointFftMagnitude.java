...
public class VisualizerViewPointFftMagnitude extends View implements VisualizerView {
    //FIELDS
    protected int id;
    ...
    //CONSTRUCTORS
    public VisualizerViewPointFftMagnitude(Context context, float strokeWidth, int color) {
        super(context);
    ...
    public VisualizerViewPointFftMagnitude(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        this.doneGettingOriginalSize = false;
        init();
        //applyCustomAttributes(context, attrs);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < magnitude.length; i++) {
            canvas.drawPoint(i*coeffX, coeffY*(256 - magnitude[i]), this.paint);
        }
